# Ansible role [vault_configuration](https://galaxy.ansible.com/ui/standalone/roles/buluma/vault_configuration/documentation)
...
# The "inmem" (Memory) storage stanza has false parameters. Use it by setting it to 'true'.
# NOT IMPLEMENTED.
